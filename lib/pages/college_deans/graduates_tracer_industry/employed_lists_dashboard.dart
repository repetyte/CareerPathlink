...
import 'employed_lists.dart'; // Import the EmployedLists page

class EmployedListsDashboard extends StatelessWidget {
  ...
  EmployedListsDashboard({super.key});
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            onTap: () {
                              // Navigate to the employed lists of the selected department
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => EmployedLists(
