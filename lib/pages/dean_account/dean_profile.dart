...
class DeanProfileScreen extends StatefulWidget {
  final CollegeDeanAccount deanAccount;
  const DeanProfileScreen({super.key, required this.deanAccount});

  @override
  _DeanProfileScreenState createState() => _DeanProfileScreenState();
}
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDetailText('User ID', widget.deanAccount.deanId),
              _buildDetailText('Name',
                  '${widget.deanAccount.firstName} ${widget.deanAccount.lastName}'),
              // _buildDetailText('Contact', _profileData?.contact),
              _buildDetailText('Email', widget.deanAccount.uncEmail,
                  isEmail: true),
    ...
    return Container(
      ...
      child: Column(
        children: [
          Stack(
            ...
            children: [
              Container(
                ...
                child: ClipOval(
                  child: Image.network(
                    "assets/images/dean_agnes_reyes.jpg",
                    fit: BoxFit.cover,
                  ),
                ),
              ),
          ...
          Text(
            'College Dean - ${widget.deanAccount.department}',
            style: GoogleFonts.montserrat(
