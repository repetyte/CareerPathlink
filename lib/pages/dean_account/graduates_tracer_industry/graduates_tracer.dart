...
class TracerDashboardDean extends StatefulWidget {
  ...
  const TracerDashboardDean({super.key, required this.collegeDeanAccount});

  @override
  State<TracerDashboardDean> createState() => _TracerDashboardDeanState();
}

class _TracerDashboardDeanState extends State<TracerDashboardDean> {
              ...
              child: Column(
                ...
                children: [
                  ListTile(
                    ...
                    title: Text(
                      '${widget.collegeDeanAccount.firstName} ${widget.collegeDeanAccount.lastName}',
                      style: const TextStyle(fontWeight: FontWeight.bold),
                    ),
                    subtitle: Text(
                        'College Dean | ${widget.collegeDeanAccount.department}'),
                  ),
                  const Divider(),
                  ListTile(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: MyDrawerDean(
        collegeDeanAccount: widget.collegeDeanAccount,
      ),
      body: Column(
        children: [
          SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        hoverableCategoryContainer(context, 'Graduates List',
                            'assets/images/graduates_list_bg.jpg', GraduatesListsDean()),
                            const SizedBox(width: 16),
                        hoverableCategoryContainer(context, 'Employed Lists',
                            'assets/images/employed_list_bg.jpg', EmployedListsDean()),
                            const SizedBox(width: 16),
                        hoverableCategoryContainer(context, 'Unemployed Lists',
                            'assets/images/unemployed_list_bg.jpg', UnemployedListsDean()),
                      ],
                    ),
                  ),
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => GraduatesTrackerDean()),
                          );
                        },
                        child: Container(
                          height: 150,
