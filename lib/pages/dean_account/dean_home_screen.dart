...
class HomeScreenDean extends StatefulWidget {
  final CollegeDeanAccount collegeDeanAccount;
  const HomeScreenDean({super.key, required this.collegeDeanAccount,});

  @override
  State<HomeScreenDean> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<HomeScreenDean> {
