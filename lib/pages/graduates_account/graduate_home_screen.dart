...
class HomeScreenGraduate extends StatefulWidget {
  final GraduateAccount graduateAccount;
  const HomeScreenGraduate({super.key, required this.graduateAccount});

  @override
  State<HomeScreenGraduate> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<HomeScreenGraduate> {
