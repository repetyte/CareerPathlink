...
class GraduatesListsDirector extends StatelessWidget {
  const GraduatesListsDirector({super.key});
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => GraduatesListsDepartmentDirector(departmentName: name),
          ),
        );
      },
      child: Container(
