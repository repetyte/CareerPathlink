...
class HendrixonJobDetailsAdmin extends StatelessWidget {
  const HendrixonJobDetailsAdmin({super.key});
                          ...
                          child: Align(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  margin:
                                      const EdgeInsets.fromLTRB(9.4, 0, 0, 0),
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                          ...
                          child: Align(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  margin:
                                      const EdgeInsets.fromLTRB(9.5, 0, 0, 0),
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                margin:
                                    const EdgeInsets.fromLTRB(0.3, 0, 0.3, 8),
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    'About Employer',
