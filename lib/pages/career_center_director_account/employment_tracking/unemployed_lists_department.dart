...
class UnemployedListsDepartmentDirector extends StatefulWidget {
  final String departmentName;

  const UnemployedListsDepartmentDirector({super.key, required this.departmentName});

  @override
  _UnemployedListsDepartmentDirectorState createState() =>
      _UnemployedListsDepartmentDirectorState();
}

class _UnemployedListsDepartmentDirectorState
    extends State<UnemployedListsDepartmentDirector> {
