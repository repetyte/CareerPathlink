...
class EmployedListsDepartmentDirector extends StatefulWidget {
  final String departmentName;

  const EmployedListsDepartmentDirector({super.key, required this.departmentName});

  @override
  _EmployedListsDepartmentDirectorState createState() =>
      _EmployedListsDepartmentDirectorState();
}

class _EmployedListsDepartmentDirectorState extends State<EmployedListsDepartmentDirector> {
  List employed = [];
