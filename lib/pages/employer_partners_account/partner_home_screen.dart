...
class HomeScreenPartner extends StatefulWidget {
  final IndustryPartnerAccount employerPartnerAccount;
  const HomeScreenPartner({super.key, required this.employerPartnerAccount, });

  @override
  State<HomeScreenPartner> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<HomeScreenPartner> {
