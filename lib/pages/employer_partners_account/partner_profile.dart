...
class PartnerProfileScreen extends StatefulWidget {
  final IndustryPartnerAccount partnerAccount;
  const PartnerProfileScreen({super.key, required this.partnerAccount});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDetailText('User ID', widget.partnerAccount.accountId),
              _buildDetailText('Name',
                  widget.partnerAccount.partnerName),
              _buildDetailText('Partner Location', widget.partnerAccount.partnerLocation),
              _buildDetailText('Contact No.', widget.partnerAccount.contactNo),
              // _buildDetailText('Contact', _profileData?.contact),
              _buildDetailText('Email', widget.partnerAccount.emailAdd,
                  isEmail: true),
          ...
          Stack(
            ...
            children: [
              Container(
                ...
                child: ClipOval(
                  child: Image.network(
                    "assets/images/employer_partner.jpg",
                    fit: BoxFit.cover,
                  ),
                ),
              ),
