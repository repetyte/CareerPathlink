...
// Create a new cancellation request
  static Future<CoachCancellationRequest> createRequest({
    ...
    final url = Uri.parse(
        'http://localhost/CareerPathlink/api/career_coaching/coach_cancellation/create_cancellation_request.php');
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception(
          'Failed to create cancellation request: ${response.body}');
    }
  }
...
//Mark as Completed
  static Future<void> markAsCompleted({
    ...
    final url = Uri.parse(
        'http://localhost/CareerPathlink/api/career_coaching/coach_cancellation/mark_as_completed.php');
  ...
  static Future<List<CoachCancellationRequest>> getRequests({
    ...
    final url = Uri.parse(
            'http://localhost/CareerPathlink/api/career_coaching/coach_cancellation/read_cancellation_requests.php')
  ...
  static Future<CoachCancellationRequest?>
      getCancellationRequestByAppointmentId(int appointmentId) async {
    try {
      final response = await http.get(
        Uri.parse(
                'http://localhost/CareerPathlink/api/career_coaching/coach_cancellation/read_cancellation_requests.php')
            .replace(
                queryParameters: {'appointment_id': appointmentId.toString()}),
      );
  ...
  static Future<CoachCancellationRequest> getRequestById(int id) async {
    final url = Uri.parse(
        'http://localhost/CareerPathlink/api/career_coaching/coach_cancellation/read_cancellation_requests.php?id=$id');
  ...
  static Future<CoachCancellationRequest> updateRequest({
    ...
    final url = Uri.parse(
        'http://localhost/CareerPathlink/api/career_coaching/coach_cancellation/update_cancellation_request.php');
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception(
          'Failed to update cancellation request: ${response.body}');
    }
  }
  ...
  static Future<void> deleteRequest(int id) async {
    final url = Uri.parse(
        'http://localhost/CareerPathlink/api/career_coaching/coach_cancellation/delete_cancellation_request.php');
    ...
    if (response.statusCode != 200) {
      throw Exception(
          'Failed to delete cancellation request: ${response.body}');
    }
  }
  ...
  static Future<int> getPendingRequestsCount(int coachId) async {
    final url = Uri.parse(
        'http://localhost/CareerPathlink/api/career_coaching/coach_cancellation/read_cancellation_requests.php?coach_id=$coachId&status=Pending');
  ...
  static Future<CoachCancellationRequest> submitStudentReply({
    ...
    final url = Uri.parse(
        'http://localhost/CareerPathlink/api/career_coaching/coach_cancellation/student_create_reply.php');
