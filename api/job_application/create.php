...
if (
    ...
    if ($application->create()) {
        ...
        echo json_encode(array("message" => "job application was created."));
    } else {
        http_response_code(503);
        echo json_encode(array("message" => "Unable to create job application."));
    }
} else {
    http_response_code(400);
    echo json_encode(array("message" => "Unable to create job application. Data is incomplete."));
}
